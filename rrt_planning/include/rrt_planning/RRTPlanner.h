...
{
  public:
    RRTPlanner(ros::NodeHandle& nh, uint max_iterations, double goal_bias);
  ...
  protected:
    ...
    typedef std::map<SpaceConfiguration, std::list<SpaceConfiguration> > RRTGraph;
    RRTGraph graph_;
    ...
    virtual void notifyTrajectory(robmovil_msgs::Trajectory& result_trajectory,
